...
**Branch:** `main`
**Commit de referência:** `e1afdd2`
**Working tree:** clean após a melhoria da sincronização de estado frontend e a atualização documental desta revisão
...
| Retenção de raws | 97 raws arquivados byte a byte, 1.189.419 bytes, 0 divergências SHA-256 na última indexação; inclui baseline e relatório de sincronização frontend. | `evidence/raw-evidence-manifest.json`, `docs/raw-evidence-index.md` |
