...
| Retenção de raws | 95 raws arquivados byte a byte, 1.186.009 bytes, 0 divergências SHA-256 na última indexação; inclui baseline, três rodadas de carga e relatório frontend-backend. | `evidence/raw-evidence-manifest.json`, `docs/raw-evidence-index.md` |
