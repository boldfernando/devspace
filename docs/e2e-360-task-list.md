...
| Retenção de raws | 89 raws arquivados byte a byte, 1.178.063 bytes, 0 divergências SHA-256 na última indexação; inclui o baseline de authz e a evidência atualizada de Block 1. | `evidence/raw-evidence-manifest.json`, `docs/raw-evidence-index.md` |
